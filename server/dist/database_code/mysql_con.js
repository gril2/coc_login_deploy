...
exports.mysqlCon = exports.db = void 0;
...
class Database {
    constructor() {
        ...
        console.log("My SQL Code Database constructor");
    ...
    async ConMySql(config) {
        try {
            this.mysqlCon = await this.mysqlConnection(config);
...
exports.mysqlCon = exports.db.getMysqlconnection();
